...
Microsoft YaHei'>本协议及附加协议适用于您的访问和使用由<span lang=EN-US>Ztuo2.0</span>（网址：</span><span
          lang=EN-US style=''>http://bhuo.top）（以下简称“<span lang=EN-US>Ztuo2.0(币火)</span>”、“本网站”或“我们”）提供的数字资产投资交易服务（统称为“本服务”）。签订其他有关本网站所提供的产品的相关协议不会影响本协议的生效。如果您代表任何机构使用本服务，您声明并保证（<span
...
text-indent:0cm'><b><span lang=EN-US style=''>一、</span></b><b><span
        ...
        <p class=MsoNormal align=left style='text-align:left'><span lang=EN-US
                                                                    style='background:white'>Ztuo2.0(币火)</span><span style='font-family:
...
text-indent:0cm;'><b><span lang=EN-US style=''>二、</span></b><b><span
        ...
        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          ...
          lang=EN-US>Ztuo2.0(币火)</span>可能不会在所有国家或地区提供本服务，并可能会对受限制地区的用户提供部分或不提供本服务，其中包括中国香港，古巴、伊朗、朝鲜、克里米亚、苏丹、马来西亚、叙利亚、美国<span
...
text-indent:0cm;'><b><span lang=EN-US style=''>四、</span></b><b><span
        ...
        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          ...
          lang=EN-US>; Ztuo2.0(币火)</span>作为平台提供商不参与实际交易。交易者必须在开始交易之前开立账户并预存数字资产。<span
          lang=EN-US>Ztuo2.0(币火)</span>不接受法定货币，也不适用法定货币结算，因此我们是一个仅提供数字资产间交易的平台。交易者可以随时要求提取其数字资产，但须遵守本协议的限制。</span></p>

        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          lang=EN-US style='background:white'>Ztuo2.0(币火)</span><span
          style='background:white'>会尽力确保网站上信息的准确性。网站上的信息和内容如有更改，恕不另行通知，且仅为协助用户以做出独立决定。<span
          lang=EN-US>Ztuo2.0(币火)</span>已采取合理措施确保网站信息的准确性。但是，我们不保证本网站所提供的任何服务或产品内容的准确性，适用性，可靠性，完整性，性能和<span
          lang=EN-US>/</span>或恰当性，且不对任何直接或间接造成的损失或损害，信息传递的延迟或失败承担责任。 <span lang=EN-US>Ztuo2.0(币火)</span>对此类信息的使用或解释不承担任何责任。</span></p>
        ...
        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          style='background:white'>用户在接受<span lang=EN-US>Ztuo2.0(币火)</span>各项服务的同时，同意接受<span
          lang=EN-US>Ztuo2.0(币火)</span>提供的各类信息服务。用户在此授权<span lang=EN-US>Ztuo2.0(币火)</span>可以向其电子邮件、手机、通信地址等发送商业信息。用户有权选择不接受<span
          lang=EN-US>Ztuo2.0(币火)</span>提供的各类信息服务，并进入<span lang=EN-US>Ztuo2.0(币火)</span>相关页面进行更改。</span></p>

        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          style='background:white'>用户理解并同意，<span lang=EN-US>Ztuo2.0(币火)</span>的服务是按照现有技术和条件所能达到的现状提供的。<span
          lang=EN-US>Ztuo2.0(币火)</span>会尽最大努力向用户提供服务，确保服务的连贯性和安全性；但<span lang=EN-US>Ztuo2.0(币火)</span>不能随时预见和防范法律、技术以及其他风险，包括但不限于不可抗力、病毒、木马、黑客攻击、系统不稳定、第三方服务瑕疵、政府行为等原因可能导致的服务中断、数据丢失以及其他的损失和风险。</span></p>

        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          style='background:white'>系统平台因下列状况无法正常运作，使用户无法使用各项服务或不能正常委托时，<span
          lang=EN-US>Ztuo2.0(币火)</span>不承担损害赔偿责任，该状况包括但不限于：</span></p>

        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          style='background:white'>（<span lang=EN-US>1</span>）<span
          lang=EN-US>Ztuo2.0(币火)</span>平台公告之系统停机维护期间；</span></p>
        ...
        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          ...
          lang=EN-US>Ztuo2.0(币火)</span>平台系统障碍不能执行业务的；</span></p>
        ...
        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          ...
          lang=EN-US>Ztuo2.0(币火)</span>有权根据实际情况取消异常成交结果，以及回滚某一段时间的所有成交。</span></p>

        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          lang=EN-US style='background:white'>Ztuo2.0(币火)</span><span
          style='background:white'>的部分服务是以收费方式提供的，如用户使用收费服务，请遵守相关的协议。<span
          lang=EN-US>Ztuo2.0(币火)</span>可能根据实际需要对收费服务的收费标准、方式进行修改和变更，<span lang=EN-US>Ztuo2.0(币火)</span>也可能会对部分免费服务开始收费。前述修改、变更或开始收费前，<span
          lang=EN-US>Ztuo2.0(币火)</span>将在相应服务页面进行通知或公告。如果用户不同意上述修改、变更或付费内容，则应停止使用该服务。</span></p>

        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          lang=EN-US style='background:white'>Ztuo2.0(币火)</span><span
          style='background:white'>不会向任何用户索取密码，不会让用户往任何非本站交易中心里提供的帐户<span
          lang=EN-US>BTC/LTC/ETH</span>充值地址打款，请大家不要相信任何<span lang=EN-US>Ztuo2.0(币火)</span>打折、优惠等信息，往非<span
...
text-indent:0cm;'><b><span lang=EN-US style=''>六、</span></b><b><span
        ...
        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          lang=EN-US style='background:white'>6.1 Ztuo2.0(币火)</span><span
          style='background:white'>认为，数字资产不应该被称为钱和法定货币，因为它们不以政府或中央银行为后盾支持。<span
          lang=EN-US>Ztuo2.0(币火)</span>不能保证数字资产市场的有序稳定。您应该在数字资产（以及任何其他资产）交易中保持谨慎。价格会随时波动。由于价格波动，您可能会有大额的盈利或亏损。任何数字资产或交易头寸都可能发生大幅度波动，甚至可能变得毫无价值。</span></p>
        ...
        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          ...
          lang=EN-US>Ztuo2.0(币火)</span>产生的追索费用也将由您承担。</span></p>
...
background:white'>7.1 Ztuo2.0(币火)</span><span style='font-size:10.5pt;
background:white'>不担保服务不会受中断，对服务的及时性、安全性都不作担保，不承担非因<span
          lang=EN-US>Ztuo2.0(币火)</span>一方网络导致的责任； </span></p>

        <p style='background:white'><span lang=EN-US style='font-size:10.5pt;
background:white'>7.2 Ztuo2.0(币火)</span><span style='font-size:10.5pt;
background:white'>不担保网站平台上的信息及服务能充分满足用户的需求。对于用户在接受<span
          lang=EN-US>Ztuo2.0(币火)</span>服务过程中可能遇到的错误、侮辱、诽谤、不作为、淫秽、色情或亵渎事件，<span lang=EN-US>Ztuo2.0(币火)</span>不承担法律责任<span
          lang=EN-US>; </span></span></p>

        <p style='background:white'><span lang=EN-US style='font-size:10.5pt;
background:white'>7.3 Ztuo2.0(币火)</span><span style='font-size:10.5pt;
background:white'>不对用户所发布信息的保存、修改、删除或储存失败负责。对网站上的非因<span
          lang=EN-US>Ztuo2.0(币火)</span>故意所导致的排版错误、疏忽等不承担责任； </span></p>

        <p style='background:white'><span lang=EN-US style='font-size:10.5pt;
background:white'>7.4 Ztuo2.0(币火)</span><span style='font-size:10.5pt;
background:white'>有权删除<span lang=EN-US>Ztuo2.0(币火)</span>内各类不符合法律或协议规定的信息，而保留不通知用户的权利<span
          lang=EN-US>; </span></span></p>

        <p style='background:white'><span lang=EN-US style='font-size:10.5pt;
background:white'>7.5 Ztuo2.0(币火)</span><span style='font-size:10.5pt;
...
background:white'>所有发给用户的通告，<span lang=EN-US>Ztuo2.0(币火)</span>都将通过正式的页常规的信件送达。任何非经<span
          lang=EN-US>Ztuo2.0(币火)</span>正规渠道获得的中奖、优惠等活动或信息，<span lang=EN-US>Ztuo2.0(币火)</span>不承担法律责任；
</span></p>

        <p style='background:white'><span lang=EN-US style='font-size:10.5pt;
background:white'>7.7 Ztuo2.0(币火)</span><span style='font-size:10.5pt;
background:white'>有权根据市场情况调整充值、提现、交易等手续费费率，有权决定免费推广期的终止； </span></p>

        <p style='background:white'><span lang=EN-US style='font-size:10.5pt;
background:white'>7.8 Ztuo2.0(币火)</span><span style='font-size:10.5pt;
background:white'>不会担任您使用本服务的任何交易的经纪人，中间人，代理人或顾问，并且<span
          lang=EN-US>Ztuo2.0(币火)</span>没有受托责任；</span></p>
...
text-indent:0cm;'><b><span lang=EN-US style=''>八、</span></b><b><span
        ...
        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          lang=EN-US style='background:white'>Ztuo2.0(币火)</span><span
          style='background:white'>尊重用户的隐私。<span lang=EN-US>Ztuo2.0(币火)</span>隐私政策单独提供，描述了<span
          lang=EN-US>Ztuo2.0(币火)</span>如何收集，存储，披露和使用与您的隐私相关的信息。您同意<span lang=EN-US>Ztuo2.0(币火)</span>根据<span
          lang=EN-US>Ztuo2.0(币火)</span>隐私政策的协议使用您的信息。</span></p>

        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          lang=EN-US style='background:white'>8.1 </span><span
          style='background:white'>本协议所称之<span lang=EN-US>Ztuo2.0(币火)</span>用户信息是指符合法律、法规及相关规定，并符合下述范围的信息：</span></p>

        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          style='background:white'>（<span lang=EN-US>1</span>）用户注册<span
          lang=EN-US>Ztuo2.0(币火)</span>时，向<span lang=EN-US>Ztuo2.0(币火)</span>提供的个人信息；</span></p>

        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          style='background:white'>（<span lang=EN-US>2</span>）用户在使用<span
          lang=EN-US>Ztuo2.0(币火)</span>服务、参加网站活动或访问网站网页时，<span lang=EN-US>Ztuo2.0(币火)</span>自动接收并记录的用户浏览器端或手机客户端数据，包括但不限于<span
        ...
        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          ...
          lang=EN-US>Ztuo2.0(币火)</span>从商业伙伴处合法获取的用户个人信息；</span></p>

        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          style='background:white'>（<span lang=EN-US>4</span>）其它<span
          lang=EN-US>Ztuo2.0(币火)</span>通过合法途径获取的用户个人信息。</span></p>

        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          lang=EN-US style='background:white'>8.2 Ztuo2.0(币火)</span><span
          style='background:white'>承诺：</span></p>

        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          style='background:white'>非经法定原因或用户事先许可，<span lang=EN-US>Ztuo2.0(币火)</span>不会向任何第三方透露用户的密码、姓名、手机号码等非公开信息<span
          lang=EN-US>;</span></span></p>
        ...
        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          ...
          lang=EN-US>Ztuo2.0(币火)</span>根据法律、法规等相关规定进行的披露。</span></p>
...
text-indent:0cm;'><b><span lang=EN-US style=''>十、</span></b><b><span
        ...
        <p class=MsoNormal align=left style='text-align:left;background:white'><span
          style='background:white'>您和<span lang=EN-US>Ztuo2.0(币火)</span>同意仲裁由本协议引起的任何争议或与本服务有关的争议，除非您和<span
          lang=EN-US>Ztuo2.0(币火)</span>不需要仲裁，任何一方就涉嫌非法使用版权，商标，商品名，标识， 商业秘密或专利权的争议寻求衡平的或其他救济。仲裁优先于在法庭起诉或进行陪审团审判。您和<span
          lang=EN-US>Ztuo2.0(币火)</span>同意您将在发生任何争议之后的三十（<span lang=EN-US>30</span>）天之内通知对方，您将在提交任何仲裁请求之前尝试非正式解决争议，任何仲裁将在香港发生，仲裁将由单一仲裁员保密地进行。您和<span
          lang=EN-US>Ztuo2.0(币火)</span>也同意，香港的法院对当事人之间的任何仲裁的上诉以及不受仲裁解决的当事人之间的任何诉讼均具有专属的管辖权。在任何仲裁中，当事人不得相互探寻彼此，仲裁员不得允许当事人探寻彼此；相反，各方应在最终听证会之前的相互同意的时间和日期披露支持其立场的证据。除了以下讨论的程序和补救措施外，仲裁员有权授予若在法庭上起诉也会授予的补救措施。您和我们也不会参与本协议涉及的任何索赔的集体诉讼或集体仲裁。如果<span
          lang=EN-US>Ztuo2.0(币火)</span>是诉讼的一方，您也同意不参与由私人律师或代表身份提出的索赔或涉及另一人的共同索赔。如果发现禁止上述第三方提起的集体诉讼和其他索赔是不可执行的，则该禁止规定视为已从本协议中删除，而与仲裁有关的其他协议应继续有效。</span></p>
...
任何与本协议所规定的内容不一致的其他文件，将不对<span lang=EN-US>Ztuo2.0(币火)</span>具有约束力。 您声明并保证所有披露给<span
            lang=EN-US>Ztuo2.0(币火)</span>的与本服务协议有关的信息是真实，准确和完整的。</span></p>
    ...
    <div v-else class="content" >
      <p>This agreement and the additional agreement shall be applicable to your visit and use of the digital assets investment transaction service provided by Ztuo2.0, (website: http://bhuo.top)hereinafter referred to as Ztuo2.0, this website or US. The conclusion of other relevant agreements relating to the products provided on this website shall not affect the entry into force of this agreement. If you use this service on behalf of any organization, you declare and guarantee (1) that the agency is a legitimate body in accordance with local laws and regulations, (2) you have the right to accept this agreement on your behalf. If you violate this agreement, the agency agrees to be responsible for your actions.</p>
      ...
      <p>We offer an online trading platform that includes digital assets for the trading of digital assets and derivatives. Traders Trade on our platform; Ztuo2.0 acts as a platform provider and does not participate in the actual transaction. A trader must open an account and pre-store digital assets before starting a transaction. Ztuo2.0 does not accept legal tender and does not use legal tender, so we are a platform that only provides digital assets to each other. The trader may at any time request the extraction of its digital assets subject to the restrictions of this agreement. </p>
      <p>Ztuo2.0 will do everything in its power to make sure the sourcing circumstances on the site. The information and content on the website is subject to change without prior notice and only to assist the user in making an independent decision. Ztuo2.0 has taken reasonable measures to ensure the sourcing circumstances of the website. However, we do not guarantee the accuracy, suitability, reliability, integrity, performance and / or appropriateness of any service or product content provided on this website and we don’t be liable for any loss or damage, whether direct or indirect, the delay or failure of the transmission of information. Ztuo2.0 does not bear any responsibility for the use or interpretation of such information.</p>
      ...
      <p>While accepting Ztuo2.0 services, users have agreed to accept various information services provided by Ztuo2.0. Users can now authorize Ztuo2.0 to send business messages to their e-mail, mobile phone, mailing address, etc. The user has the right to choose not to accept the various information services provided by Ztuo2.0 and to enter the Ztuo2.0-related page for change.</p>
      <p>Users understand and agree that the services of Ztuo2.0 are provided in accordance with the current state of affairs that can be achieved in accordance with available technology and conditions. Ztuo2.0 will do its utmost to provide services to users to ensure the continuity and security of services, but Ztuo2.0 is not always able to foresee and guard against legal, technical and other risks, these include, but are not limited to terrorist attack , viruses, hacker attacks, systemic instability, third party service flaws, government actions, and so on.</p>
      <p>The system platform can not function properly due to the fact that the user is unable to use the services or is not able to properly delegate, the Ztuo2.0 does not assume liability for damages, including but not limited to:</p>
      <p>A.Downtime of the Ztuo2.0 Platform Bulletin System</p>
      <p>B.Failure of telecommunications equipment to transmit data</p>
      <p>C.Factors such as typhoons, earthquakes, tsunamis, floods, power, wars, terrorist attacks, etc, causing the Ztuo2.0 platform system to fail to perform business</p>
      ...
      <p>Some of the services of Ztuo2.0 are provided on a fee basis. If you are using a fee-based service, please comply with the relevant agreement. Ztuo2.0 may modify and change the fee-charging standards and methods according to actual needs, and Ztuo2.0 may also start charging for some of the free services. Prior to the amendment, change or commencement of the charge, Ztuo2.0 will be notified or advertised on the corresponding service page. If the user does not agree with the above changes, changes or paid content, it should stop using the service.</p>
      <p>Ztuo2.0 does not ask for passwords from any user and does not allow users to make payments to the account BTC/ LTC/ ETH provided in any non-site trading centre. Please do not trust any Ztuo2.0 discount, discount, etc, it is not responsible for any loss of money or money in the account, address, or account provided by the non-BTC / LTC / ETH trading centre. Transaction exception handling: user consent and approval when using this service may be rendered unserviceable due to the problem of digital currency network connection or other irresistible factors. Users ensure that the information you have entered is correct. The site will not be liable for any damages if it is unable to notify the user in time of the occurrence of any of the above abnormal circumstances due to a data error.</p>
      ...
      <p>6.4 When using this service, you will contact the user to recover any improper gains arising from potential undetected vulnerabilities in the site's trading rules, otherwise, we will take the following measures, including, but not limited to, restrictions on account transactions, freezing of account funds and prosecution of cases before competent courts, and the recovery costs incurred by the Ztuo2.0 arising from the lack of effective user cooperation. 
</p>
      <p><b>7.Disclaimer
</b></p>
      <p>7.1 The non-guarantee service of Ztuo2.0 will not be interrupted, nor will it guarantee the timeliness and security of the service and will not be liable for any liability arising from the network of Ztuo2.0.</p>
      <p>7.2 Ztuo2.0 does not guarantee that the information and services on the plat form of the web site can fully meet the needs of users. Ztuo2.0 is not liable for any errors, insults, defamation, omissions, obscenity, pornography or profanity that may have been encountered in the course of accepting Ztuo2.0 services.</p>
      <p>7.3 Ztuo2.0 is not responsible for the failure of the user to save, modify, delete, or store information. To the website not because of Ztuo2.0 intentionally caused typo error, neglect and so on.</p>
      <p>7.4 Ztuo2.0 has the right to delete all types of information in Ztuo2.0 that do not conform to the provisions of the law or the agreement, while retaining the right not to notify the user.</p>
      <p>7.5 The user comments made by all users in the Ztuo2.0  only represent the personal views of the user and do not mean that the site agrees with these views or confirms these descriptions, and that this website does not bear any legal liability arising from user comments.</p>
      <p>7.6 All notices sent to users, Ztuo2.0 will be delivered by formal page-by-letter delivery. Any activities or information obtained through the regular channels of Ztuo2.0 shall not be subject to legal liability.</p>
      <p>7.7 Ztuo2.0 shall have the right to decide the termination of the free promotion period by adjusting the charge rate of charges such as charging, cashing and trading according to the market conditions.</p>
      <p>7.8 Ztuo2.0 will not act as a broker, intermediary, agent or consultant for any transaction in which you use this service, and Ztuo2.0 is not liable.</p>
      <p><b>8. Privacy Statement</b></p>
      <p>Ztuo2.0 respects the privacy of its users. The privacy policy of Ztuo2.0 is provided separately, describing how Ztuo2.0 collects, stores, discloses and Uses Information Relevant to your privacy. You agree with Ztuo2.0 to use your information under the Ztuo2.0 privacy policy agreement.</p>
      <p>8.1 The term, Ztuo2.0 customer information, in this agreement refers to information that conforms to the laws, regulations and relevant regulations and is consistent with the following scope:</p>
      <p>A.The personal information provided to Ztuo2.0 when a user registers.
</p>
      <p>B.When a user uses the Ztuo2.0 service, participates in a website activity or visits a web page, Ztuo2.0 automatically receives and records the user's browser or mobile client data, includes, but is not limited to, the IP address, the information in the website Cookie, and the web records requested by the user.
</p>
      <p>C.User's personal information legally obtained from a business partner by Ztuo2.0.
</p>
      <p>D.Other user's personal information obtained by legal means by other Ztuo2.0.
</p>
      <p>8.2 Ztuo2.0 commitment</p>
      ...
      <p>C.other Ztuo2.0 (currency and fire) disclosure in accordance with the relevant provisions of laws and regulations.
</p>
      ...
      <p>These agreements provide for a complete understanding of the subject matter and supersede all previous understandings and communications related to them. Any other document inconsistent with the provisions of this agreement shall not be binding on Ztuo2.0. You declare and certify that all information disclosed to Ztuo2.0 in connection with this service agreement is true, accurate and complete.</p>
    </div>
  </div>
</template>
<script>
