  ...
  <div class="about_us_container">
    <div class="wrapper">
      ...
      <div class="content_wrapper">
        <div class="content1">
          <h5>Ztuo2.0</h5>
          <p>Ztuo2.0,我们拥有领先的技术实力、优质的客户服务和良好的用户体验,为广大数字货币爱好者提供一个自由的网上交换的平台。</p>
          <p>Ztuo2.0</p>
          <p>Ztuo2.0（币火）国际数字加密资产交易平台海外运营中心分别设立在新加坡、柬埔寨、马绍尔，国内北京、郑州、深圳三大办事处，中国总部设立在海南陵水清水湾国际信息产业园。</p>
        </div>
        <div class="content1">
          <h5>Ztuo2.0理念</h5>
          <p>当下数字资产发展如火如荼，良莠不齐。Ztuo2.0会筛选优质数字资产，重视项目的透明度和治理结构，在自有评级体系形成的筛选标准之上，参考市场投资者的决策，共同发掘优质数字资产价值。</p>
          <p>我们的理念是：与每一位自由汇集于此的成员共同塑造一方价值流通、合抱共耕的优质生态土壤。</p>
        </div>
        <div class="content1" style="border:none;">
          <h5>Ztuo2.0目标</h5>
          <p>Ztuo2.0的目标是建立一个相对去中心化的交易平台。平台的运营环境安全、公平而良性的发展，有创新、可迭代，符合社会进步和发展的趋势。</p>
        </div>
      </div>
    </div>
  </div>
