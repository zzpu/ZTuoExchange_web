...
module.exports = {
    ...
    description: {
        ...
        // message3: 'Ztuo2.0数字资产交易平台支持每秒1000笔交易，给用户带来酣畅淋漓\n的交易体验',
        title1: '安全',
        title2: '快捷',
        title3: '体验',
        ...
        message5: 'Ztuo2.0国际数字加密资产交易平台手机客户端，专注掌上交易体验',
    },
    financeNav: {
        wdzc: '我的资产'
    },
    index: {
        ...
        BHBregister: "Ztuo2.0网账户注册",
        tibi: "提币到账时间及限额",
        line_plane: "BHB上线计划、流通量及手续费返还公告",
        fenpeijizhi: '关于Ztuo2.0收入分配机制的说明',
        jiangli_jihua: "邀请挖矿奖励计划",
        friend_fanhuan: "邀请好友、赚取额外手续费返还"
    },
    plate: {
        title: "平台收入分配方案 (BHB 持有者权益)",
        content1: "正如白皮书所描述的，Ztuo2.0会拿出平台的80% (扣除税费后) 的收入分配给Ztuo2.0持有者，20%的收入用来支持平台的研发及运营。",
    ...
    feereturn: {
        ...
        /*time:"日期",
        todaycharge:"当日Ztuo2.0均价(ETH)",
        totalChange:'当日总手续费折合(ETH)',
        returnCharge:"当日挖矿手续费返还(BHB)",
        todayChargeReturn:"当日挖矿收入倍增计划返还（BHB）"*/
    },
    aboutUs: {
        c1: "Ztuo2.0（币火）国际数字加密资产交易平台是一个综合数字资产交易平台,我们拥有领先的技术实力、优质的客户服务和良好的用户体验,为广大数字货币爱好者提供一个自由的网上交换的平台。",
        c2: "Ztuo2.0（币火）国际数字加密资产交易平台同时还提供数字货币白皮书规划、加密算法调整、数字货币研发、交易平台上架一条龙的区块链服务。",
        c3: "Ztuo2.0（币火）国际数字加密资产交易平台海外运营中心分别设立在新加坡，柬埔寨，马绍尔。国内北京，郑州，深圳三大办事处；中国总部设立在海南陵水清水湾国际信息产业园。"
    }
}