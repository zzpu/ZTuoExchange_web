...
module.exports = {
    ...
    footer: footer,
    topInfo: {
        name: 'Ztuo2.0--International Digital encryption asset trading platform',
    },
    common: {
        login: 'Log In',
        register: 'Sign Up',
    ...
    uc: {
        ...
        identity: {
            ...
            become: "Become Ztuo2.0 Certified Business and enjoy more transaction privileges",
    ...
    description: {
        ...
        // message3: 'Ztuo2.0 Exchange supports 10,00 transactions per second, giving users a hearty transaction experience',
        message4: 'Multi-terminal APP, easily traded between',
        message5: 'Ztuo2.0 international digital encryption asset trading platform mobile client, focusing on palm trading experience',
    },
    index: {
        ...
        BHBregister: "Ztuo2.0 account registration",
        ...
        fenpeijizhi: 'A description of the Ztuo2.0 income distribution mechanism',
    ...
    plate: {
        ...
        content1: "As described in the white paper, Ztuo2.0 will take up 80% of the platform (after deduct Taxes and fees )The income is allocated to BHB holders, and 20% of revenue is used to support R & D and operation of the platform.",
